        ...
        <tbody>
            @forelse($data as $tenant)
                ...
                <tr>
                    ...
                    <td>{{ $roomNo }}</td>
                    <td>{{ \Carbon\Carbon::parse($lease->lea_start_date ?? $lease->lea_start ?? now())->format('Y-m-d') }}</td>
                    <td>{{ \Carbon\Carbon::parse($lease->lea_end_date ?? $lease->lea_end ?? now())->format('Y-m-d') }}</td>
